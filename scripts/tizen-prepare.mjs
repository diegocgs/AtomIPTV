 ...
 * `tizen package -t wgt` **sem** shell (só a SPA embutida).
 *
 * Para o pacote com **shell + iframe** (shell.js, runtime-config.js, …), use
 * `npm run build:tizen` em vez deste script.
 */
...
/** PNG 1×1 mínimo (substituir por ícone 512×512 antes de publicar). */
...
function ensureIcon() {
  if (!existsSync(iconSrc)) {
    ...
    console.warn(
      '[tizen-prepare] Criado tizen/icon.png placeholder (1×1). Substitua por ícone TV (≥512×512) antes da loja.',
    )
  }
}
